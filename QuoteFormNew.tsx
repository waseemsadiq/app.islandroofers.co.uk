        ...
        return (
          <div className="space-y-6">
            <h2 className="text-xl font-semibold mb-4">
              <img
                src="https://www.islandroofers.co.uk/images/ir-logo.png"
                alt="Island Roofers Logo"
                className="h-24 w-auto object-contain hidden print:inline-block mr-2"
              />
  ...
  return (
    <div className="w-full max-w-2xl p-6 bg-white rounded-lg shadow-lg print:shadow-none">
      ...
      <      <div className="flex justify-between mt-8 print:hidden">
        ...
        <button
          onClick={clearForm}
          className="flex items-center px-4 py-2 text-red-600 hover:text-red-800 ml-2"
        >
          Clear Form
        </button>
